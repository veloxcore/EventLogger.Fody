...
public class CustomTests
{
    ...
    //    instance.Debug();
    //    var message = MyLoggerFactory.DebugEntries.First();
    ...
    //    instance.Method();
    //    Assert.AreEqual(1, MyLoggerFactory.ErrorEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.ErrorEntries.First().Format.StartsWith("Method: 'void Method()'. Line: ~"));
    //}
    ...
    //    var instance = (dynamic) Activator.CreateInstance(type);
    //    instance.Debug();
    //    Assert.AreEqual(1, MyLoggerFactory.DebugEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.DebugEntries.First().Format.StartsWith("Method: 'void Debug()'. Line: ~"));
    //}
    ...
    //    CheckException(action, MyLoggerFactory.TraceEntries, expected);
    //}
    ...
    //    CheckException(action, MyLoggerFactory.DebugEntries, expected);
    //}
    ...
    //    CheckException(action, MyLoggerFactory.InformationEntries, expected);
    //}
    ...
    //    CheckException(action, MyLoggerFactory.WarningEntries, expected);
    //}
    ...
    //    CheckException(action, MyLoggerFactory.ErrorEntries, expected);
    //}
    ...
    //    CheckException(action, MyLoggerFactory.FatalEntries, expected);
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.TraceEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.TraceEntries.First().Format.StartsWith("Method: 'void TraceString()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.TraceEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.TraceEntries.First().Format.StartsWith("Method: 'void TraceStringFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.TraceEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.TraceEntries.First().Format.StartsWith("Method: 'void TraceStringParams()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.TraceEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.TraceEntries.First().Format.StartsWith("Method: 'void TraceStringException()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.TraceEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.TraceEntries.First().Format.StartsWith("Method: 'void TraceStringExceptionFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.DebugEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.DebugEntries.First().Format.StartsWith("Method: 'void DebugString()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.DebugEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.DebugEntries.First().Format.StartsWith("Method: 'void DebugStringFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.DebugEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.DebugEntries.First().Format.StartsWith("Method: 'void DebugStringParams()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.DebugEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.DebugEntries.First().Format.StartsWith("Method: 'void DebugStringException()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.DebugEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.DebugEntries.First().Format.StartsWith("Method: 'void DebugStringExceptionFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.InformationEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.InformationEntries.First().Format.StartsWith("Method: 'void Information()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.InformationEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.InformationEntries.First().Format.StartsWith("Method: 'void InformationString()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.InformationEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.InformationEntries.First().Format.StartsWith("Method: 'void InformationStringFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.InformationEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.InformationEntries.First().Format.StartsWith("Method: 'void InformationStringParams()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.InformationEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.InformationEntries.First().Format.StartsWith("Method: 'void InformationStringException()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.InformationEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.InformationEntries.First().Format.StartsWith("Method: 'void InformationStringExceptionFunc()'. Line: ~"));
    //}
    ...
    //    var instance = (dynamic) Activator.CreateInstance(type);
    //    instance.Warning();
    //    Assert.AreEqual(1, MyLoggerFactory.WarningEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.WarningEntries.First().Format.StartsWith("Method: 'void Warning()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.WarningEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.WarningEntries.First().Format.StartsWith("Method: 'void WarningString()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.WarningEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.WarningEntries.First().Format.StartsWith("Method: 'void WarningStringFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.WarningEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.WarningEntries.First().Format.StartsWith("Method: 'void WarningStringParams()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.WarningEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.WarningEntries.First().Format.StartsWith("Method: 'void WarningStringException()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.WarningEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.WarningEntries.First().Format.StartsWith("Method: 'void WarningStringExceptionFunc()'. Line: ~"));
    //}
    ...
    //    instance.Error();
    //    Assert.AreEqual(1, MyLoggerFactory.ErrorEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.ErrorEntries.First().Format.StartsWith("Method: 'void Error()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.ErrorEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.ErrorEntries.First().Format.StartsWith("Method: 'void ErrorString()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.ErrorEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.ErrorEntries.First().Format.StartsWith("Method: 'void ErrorStringFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.ErrorEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.ErrorEntries.First().Format.StartsWith("Method: 'void ErrorStringParams()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.ErrorEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.ErrorEntries.First().Format.StartsWith("Method: 'void ErrorStringException()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.ErrorEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.ErrorEntries.First().Format.StartsWith("Method: 'void ErrorStringExceptionFunc()'. Line: ~"));
    //}
    ...
    //    var instance = (dynamic) Activator.CreateInstance(type);
    //    instance.Fatal();
    //    Assert.AreEqual(1, MyLoggerFactory.FatalEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.FatalEntries.First().Format.StartsWith("Method: 'void Fatal()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.FatalEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.FatalEntries.First().Format.StartsWith("Method: 'void FatalString()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.FatalEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.FatalEntries.First().Format.StartsWith("Method: 'void FatalStringFunc()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.FatalEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.FatalEntries.First().Format.StartsWith("Method: 'void FatalStringParams()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.FatalEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.FatalEntries.First().Format.StartsWith("Method: 'void FatalStringException()'. Line: ~"));
    //}
    ...
    //    Assert.AreEqual(1, MyLoggerFactory.FatalEntries.Count);
    //    Assert.IsTrue(MyLoggerFactory.FatalEntries.First().Format.StartsWith("Method: 'void FatalStringExceptionFunc()'. Line: ~"));
    //}
    ...
    //    Assert.IsTrue(MyLoggerFactory.DebugEntries.First().Format.StartsWith("Method: 'Void AsyncMethod()'. Line: ~"));
    //}
    ...
    //    var message = MyLoggerFactory.DebugEntries.First().Format;
    ...
    [Test]
    public void StartEvent_EventName()
    {
        var type = assembly.GetType("ClassMethodWithEventName");
        var instance = (dynamic)Activator.CreateInstance(type);
        instance.StartEvent();
        //Assert.AreEqual(2, MyLoggerFactory.InformationEntries.Count);
        //Assert.IsTrue(MyLoggerFactory.InformationEntries.First().Message.StartsWith("Method "));
    }
}